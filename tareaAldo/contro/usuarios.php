      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="editar.php?id=<?php echo $usuarios_row['id']; ?>&user=<?php echo $usuarios_row['user']; ?>&pass=<?php echo $usuarios_row['pass']; ?>&mail=<?php echo $usuarios_row['mail']; ?>" class="btn btn-info">Editar</a>
              <br>
              <a href="borrar.php?id=<?php echo $usuarios_row['id']; ?>" class="btn btn-info">Borrar</a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
